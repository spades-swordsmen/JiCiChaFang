function mag(show,bigshow,smallshow,mask,bigitem){
    ...
    this.obj={
        prev:'.prev',next:'.next',middle:'.middle',middleBox:'.middle_box'
    }
}
mag.prototype={
    init:function(){
        ...
        $(that.obj.prev).click(function(){
            ...
            $(that.obj.next).click(function(){
                if($(that.obj.middle).width()-$(that.obj.middleBox).width()>0){
                    ...
                    if(shuzi>$(that.obj.middleBox).width()){$(that.obj.middle).css("marginLeft",-$(that.obj.middleBox).width()+parseInt($(that.obj.middle).css("marginLeft")))}
